...
ROOT1 = "/Volumes/lymphdev\$/IreneR/Confocal/IFNGrescueburst/Phdla/Exp1/"
ROOT2 = "/Volumes/lymphdev\$/IreneR/Confocal/IFNGrescueburst/Phdla/Exp2/"
...
root1 = ROOT1
exp = CSV.read("IbidiChambers/Phdla_IFNGrescue_exp1.csv", DataFrames.DataFrame)
expn = 1
gene = "Phdla_intron"
typeprobe = "type4"
...
root1 = ROOT2
exp = CSV.read("IbidiChambers/Phdla_IFNGrescue_exp2.csv",  DataFrames.DataFrame)
expn = 2
gene = "Phdla_intron"
typeprobe = "type4"
tss1 = CSV.read("TSS_raw/"*gene*"_exp"*"$expn"*".csv",  DataFrames.DataFrame)
